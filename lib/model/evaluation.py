...
def batch_inference_eval(args, model_pos, batch_input, batch_gt_torso, batch_gt_limb_pos):
    if args.flip:    
        ...
        if args.model in ['DHDSTformer_total', 'DHDSTformer_total2', 'DHDSTformer_total3', 'DHDSTformer_total6', 'DHDSTformer_total7']: 
...
def calculate_eval_metric(args, results_all, datareader):
    ...
    for idx in range(len(results_all)):
        ...
        if (args.model in ['DHDSTformer_total', 'DHDSTformer_total2', 'DHDSTformer_total3', 'DHDSTformer_total4', 'DHDSTformer_total5', 'DHDSTformer_total6', 'DHDSTformer_total7', 'DHDSTformer_torso', 'DHDSTformer_torso_limb', 'DHDSTformer_right_upper_arm2']) or ('MB' in args.model): # only model that predict pelvis point
