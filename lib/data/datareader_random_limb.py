...
class DataReaderRandomLimb(object):
    def __init__(self, n_frames, sample_stride, data_stride_train, data_stride_test, read_confidence=True, dt_root = 'data/motion3d', dt_file = 'random_limb_train1600_test400.pkl'):
...
#       Only Testset HW is needed for denormalization
    ...
    def get_sliced_data(self):
        ...
        print('2d train_data', train_data.shape, '2d test_data', test_data.shape)
        train_labels, test_labels = self.read_3d() # train_labels (1559752, 17, 3) test_labels (566920, 17, 3)
        print('3d train_labels', train_labels.shape, '3d test_labels', test_labels.shape)
        split_id_train, split_id_test = self.get_split_id()
