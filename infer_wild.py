...
def parse_args():
    ...
    parser.add_argument('-e', '--evaluate', default='checkpoint/pose3d/FT_MB_ft_h36m_MB_ft_aihub_243/latest_epoch.bin', type=str, metavar='FILENAME', help='checkpoint to evaluate (file name)')
