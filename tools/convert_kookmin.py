...
datareader = DataReaderKOOKMIN(n_frames=243, sample_stride=1, data_stride_train=81, data_stride_test=243, dt_file = 'kookmin_total_with_kookmin_setting2_s0258_test_with_mmpose_test.pkl', dt_root='data/motion3d/')
...
root_path = "data/motion3d/MB3D_f243s81/KOOKMIN_TOTAL_WITH_KOOKMIN_SETTING2_S0258_TEST_WITH_MMPOSE_TEST"
