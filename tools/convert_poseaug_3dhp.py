...
datareader = DataReaderPOSEAUG3DHP(n_frames=243, sample_stride=1, data_stride_train=81, data_stride_test=243, dt_file = 'poseaug_3dhp_test.pkl', dt_root='data/motion3d/', mode='cam_3d')
