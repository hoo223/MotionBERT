...
datareader = DataReaderFIT3D(n_frames=243, sample_stride=1, data_stride_train=81, data_stride_test=243, dt_file = 'fit3d_gt_ts_s4710.pkl', dt_root='data/motion3d/', mode='cam_3d')
...
root_path = "data/motion3d/MB3D_f243s81/FIT3D-GT-CAM_NO_FACTOR-TS-S4710/"
