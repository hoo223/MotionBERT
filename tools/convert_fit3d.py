...
datareader = DataReaderFIT3D(n_frames=243, sample_stride=1, data_stride_train=81, data_stride_test=243, 
                             dt_file = 'fit3d_gt_canonical_3d_fixed_dist_5_all_test.pkl', 
...
root_path = "data/motion3d/MB3D_f243s81/FIT3D-GT-CAM_NO_FACTOR-INPUT_FROM_3D_CANONICAL_FIXED_DIST_5-ALL_TEST/"
#root_path = "data/motion3d/MB3D_f243s81/FIT3D-GT-ALL_TEST/"
if not os.path.exists(root_path):
    os.makedirs(root_path)
