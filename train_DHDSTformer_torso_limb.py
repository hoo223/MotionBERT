...
from lib.model.DHDSTformer import DHDSTformer, DHDSTformer2, DHDSTformer3, DHDSTformer_torso, DHDSTformer_torso_limb
...
def evaluate(args, model_pos, test_loader, datareader):
    ...
    part_list = ['torso', 'arms', 'legs'] # ['whole', 'torso', 'arms', 'legs', 'pelvis', 'r_hip', 'l_hip', 'torso', 'neck', 'l_shoulder', 'r_shoulder', 'l_elbow', 'l_wrist', 'r_elbow', 'r_wrist', 'r_knee', 'r_ankle', 'l_knee', 'l_ankle']
